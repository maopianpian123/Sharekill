...
public class RsaUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		RSAPrivateKey privateKey = RsaUtils.loadPrivateKeyByStr(RsaUtils.otherPrivateKey);
		System.out.println("decript result" + new String(RsaUtils.decrypt(privateKey, RsaUtils.getDecode("MRtrAhQeQ2Uw8FBpxKhhV9sUi7cvPKbJYdSRcoRli1DLexUEaYpU0XvkHnbfASe+HjgMXXmcrNuBPnZNXo9x/mAxD9SoQMwbdZxbp02b3u31aidk5kOVRIjs68odpOPD6d2avxPN4WqK8V+BGozuqw4pGtueCtYVu+znwVj7GCE="))));
	}
    ...
    public static String otherPrivateKey = "MIICeAIBADANBgkqhkiG9w0BAQEFAASCAmIwggJeAgEAAoGBAOJmd+tciFDLf4na"
    ...
    public static byte[] getDecode(String data){
